...
export const CASINOS: Casino[] = [
  ...
  { id: "wintino", name: "Wintino", rating: 4.9, bonus: "150% fino a 1.000 € + 300 giri gratuiti", color: "#1a1a1a", license: "Curaçao eGaming", minDeposit: "20 €", payout: "24 h", live: true, crypto: true, url: "https://wtno.pslera.com/?mid=377856_2192537", logo: wintinoLogo.url },
  ...
  { id: "stonevegas", name: "StoneVegas", rating: 4.9, bonus: "Bonus di benvenuto 500 € + 200 giri gratuiti", color: "#3a2416", license: "Curaçao eGaming", minDeposit: "20 €", payout: "24-48 h", live: true, crypto: true, url: "https://stnvgs.pleotra.com/?mid=334563_2191545", logo: stonevegasLogo.url },
  { id: "richroyal", name: "Rich Royal", rating: 4.9, bonus: "275 € fino a 7.500 + 225 FS + Bonus Granchio", bonus2: "700 € + 50 giri gratis sui primi depositi", color: "#1b3a5f", license: "Curaçao eGaming", minDeposit: "10 €", payout: "1-24 h", live: true, crypto: true, url: "https://rchrl.fynkelto.com/?mid=285174_2145320", logo: richroyalLogo.url },
  { id: "royalsea", name: "RoyalSea", rating: 5.0, bonus: "+120% al deposito + 100 giri gratuiti + 200 cristalli", color: "#ffffff", license: "Curaçao eGaming", minDeposit: "20 €", payout: "24 h", live: true, crypto: true, url: "https://click2dep.g2afse.com/click?pid=494&offer_id=1940", logo: royalseaLogo.url },
  { id: "nitrobet", name: "Nitrobet", rating: 5.0, bonus: "500% + 350 giri gratuiti - pacchetto Nitro Power", color: "#1e3a2a", license: "Anjouan Gaming", minDeposit: "10 €", payout: "1-24 h", live: true, crypto: true, url: "https://record.nospartners.com/__BBFWysCs1VqkvbhkiKqDGNd7ZgqdRLk/1/?pg=1", logo: nitrobetLogo.url },
